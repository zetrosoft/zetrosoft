...
### 🛠️ Tech Stack & Tools
- **Core Languages:** ![Python](https://img.shields.io/badge/-Python-3776AB?style=flat&logo=python&logoColor=white) ![Go](https://img.shields.io/badge/-Go-00ADD8?style=flat&logo=go&logoColor=white) ![JavaScript](https://img.shields.io/badge/-JavaScript-F7DF1E?style=flat&logo=javascript&logoColor=black)
- **Frameworks:** **Frappe/ERPNext**, FastAPI, Next.js, React.js
- **Future Tech:** **Web3 & Blockchain Development**, **AI Agents (x402/ERC8004)**, **Ollama (Local AI)**
- **Infrastructure:** Docker, PostgreSQL, Linux Server (DevOps)
